...
export default function ParticlesBackground() {
  ...
  useEffect(() => {
    ...
    const particles: { x: number; y: number; speedX: number; speedY: number; size: number; color: string }[] = []
    ...
    function drawParticle(particle: { x: number; y: number; size: number; color: string }) {
