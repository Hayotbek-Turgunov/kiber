...
export default function StatsSection({ className = "" }) {
  ...
  const stats = [
    { icon: <Users className="w-8 h-8" />, value: "500+", label: "Bitiruvchilar" },
    { icon: <Award className="w-8 h-8" />, value: "50+", label: "Sertifikatlar" },
    { icon: <BookOpen className="w-8 h-8" />, value: "1000+", label: "Dars soatlari" },
    { icon: <Trophy className="w-8 h-8" />, value: "100%", label: "Natija" },
  ]

  return (
    <div ref={sectionRef} className={`py-12 ${className}`}>
