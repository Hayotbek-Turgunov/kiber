...
const phrases = ["Kiberxavfsizlik", "Xakerlik", "Malware Tahlili", "Tarmoq Xavfsizligi", "Kriptografiya"]
    ...
    <div className={`relative overflow-hidden py-12 sm:py-20 ${className}`}>
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center">
          ...
          >
            5 oylik kurs davomida zamonaviy kiberxavfsizlik ko'nikmalarini o'rganing va yuqori maoshli mutaxassisga
            aylaning.
          </motion.p>
          <motion.div
